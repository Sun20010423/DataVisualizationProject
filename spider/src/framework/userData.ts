...
import { Constant, LIFF_USER } from "./constant";
...
export class UserData {
    ...
    private _billboardListText: string = '';
    ...
    public get billboardListText() {
        return this._billboardListText;
    }

    public set billboardListText(v: any) {
        this._billboardListText = v;
    }
    ...
    public get liffInfo() {
        return this._liffInfo;
    }

    public set liffInfo(v: LIFF_USER) {
        this._liffInfo = v;
    }
