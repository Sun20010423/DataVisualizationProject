...
export class StorageManager {
    ...
    start() {
        ...
        content = localStorage.getItem(this.KEY_CONFIG);
 ...
 */
    public setToken(token: string) {
        this._jsonData.userId = token;
        if (!this._jsonData[token]) {
            this._jsonData[token] = {};
        }
    ...
    public save() {
        ...
        localStorage.setItem(this.KEY_CONFIG, zipStr);
